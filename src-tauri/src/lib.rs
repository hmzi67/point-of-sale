...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::printer_print_diagnostic,
            ...
            commands::tables_shift_table_order,
            commands::counters_get_counters,
            commands::counters_add_counter,
            commands::counters_update_counter,
            commands::counters_set_active,
            commands::tokens_get_pending_items,
            commands::tokens_get_for_order,
            commands::tokens_print,
            commands::tokens_reprint,
            commands::tokens_get_adhoc_groups,
            commands::tokens_print_adhoc,
