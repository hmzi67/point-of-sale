...
export function downloadTableSalesPdf(report: TableSalesSummary, config: AppConfig): void {
  buildTableSalesPdf(report, config).save(`table-wise-sales-${report.startDate}-to-${report.endDate}.pdf`);
}
